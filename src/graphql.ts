...
export abstract class IMutation {
    ...
    abstract createRating(recipeId: string, input?: Nullable<CreateRatingInput>): Rating | Promise<Rating>;

    abstract deleteRating(recipeId: string): boolean | Promise<boolean>;

    abstract createRecipe(input: CreateRecipeInput): Recipe | Promise<Recipe>;

    abstract updateRecipe(id: string, input: UpdateRecipeInput): Recipe | Promise<Recipe>;
